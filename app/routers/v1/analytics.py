...
@router.get(
    ...
    summary="Get incomes, expenses and total balance in user's default currency")
async def get_user_current_balance(
    ...
    total_balance = get_user_total_balance_in_default_currency(session, user_id, default_currency)
...
@router.get(
    ...
    summary="Get total income in user's default currency")
...
@router.get(
    ...
    summary="Get total expense in user's default currency")
